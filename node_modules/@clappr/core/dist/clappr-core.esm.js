  ...
  _createClass(HTML5Video, [{
    ...
    value: function _scheduleUpdateSettingsCheck() {
      ...
      this._updateSettingsCheckInFlight = setTimeout(function () {
        _this5._updateSettings();
        _this5._updateSettingsCheckInFlight = null;
      }, 1000);
    }
  }, {
    key: "_onTimeUpdate",
...
export { zepto as $, BaseObject, Browser, Container, ContainerPlugin, Core, CorePlugin, Events, HTML5Audio, HTML5Video, HTMLImg, Loader, Log, Playback, Player, PlayerError, Styler, UIContainerPlugin, UICorePlugin, UIObject, Utils, main as default, tmpl as template, version };
