  ...
  configure_blacklight do |config|
    ...
    config.default_document_solr_params = {
     ...
     # q: '{!term f=id v=$id}'
      ...
      :"hl.fl" => "biographical_t, subject_t, description_t, person_present_t, place_t, interviewer_history_t, process_interview_t, type_of_resource_display, audio_b, extent_display, language_t, author_t, interviewee_t, title_t, subtitle_t, series_t, links_t",
      :"hl.simple.pre" => "<span class='label label-warning'>",
      :"hl.simple.post" => "</span>",
