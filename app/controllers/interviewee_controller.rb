class IntervieweeController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field 'extent_t', label: 'Length', highlight: true
    config.add_index_field 'language_t', label: 'Language', highlight: true
    config.add_index_field 'audio_b', label: 'Audio', highlight: true, helper_method: 'audio_icon'
    config.add_index_field 'abstract_t', label: 'Series Statement', highlight: true, helper_method: 'index_filter'
    config.add_index_field 'biographical_t', label: 'Biographical Note', highlight: true, helper_method: 'index_filter'
